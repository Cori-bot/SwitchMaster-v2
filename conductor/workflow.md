...
4. **High Code Coverage:** Requirement of 100% code coverage for all modules
...
8. **Commit Code Changes:**
   ...
   - Propose a clear, concise commit message that includes a detailed summary of the task.
   - Perform the commit.
...
3.  **Execute Automated Tests with Proactive Debugging:**
    ...
    -   **Example Announcement:** "I will now run the automated test suite to verify the phase. **Command:** `CI=true pA test`"
