...
const Dashboard: React.FC<DashboardProps> = ({
  ...
  // Use refs to keep track of latest state for event handlers without triggering re-renders
  ...
  const handleDrop = React.useCallback((e: React.DragEvent, id: string) => {
    e.preventDefault();
    setDraggedId(null);
    onReorderRef.current(localAccountsRef.current.map((a) => a.id));
  }, []);
