    ...
    <div className="h-screen w-screen bg-[#0a0a0a] text-white flex flex-col p-6 overflow-hidden select-none font-sans relative">
      ...
      <header className="flex items-center justify-between mb-8 relative z-50 w-full pointer-events-none">
        <div className="flex items-center gap-4 pointer-events-auto drag select-none">
          ...
          <div>
            <h1 className="text-xl font-black tracking-tighter leading-none uppercase italic border-b-2 border-blue-600/50 pb-1">
              Visper
            </h1>
            <p className="text-[9px] text-blue-400/80 font-bold uppercase tracking-[0.3em] mt-1.5 ml-1">
              Intelligence Layer
            </p>
          </div>
        </div>
        ...
        {session && (
          <div
            className="relative z-50 pointer-events-auto no-drag"
            ref={menuRef}
          >
            <button
            ...
            >
              ...
              <div className="relative">
                <img
                  src={rankIcon}
                  alt="Rank"
                  className="w-10 h-10 object-contain relative drop-shadow-md"
                />
              </div>

              <ChevronDown
                size={16}
                className={`text-white/30 transition-transform duration-300 ${isMenuOpen ? "rotate-180" : ""}`}
              />
            </button>
              ...
              {isMenuOpen && (
                ...
                >
                  <div className="p-3 border-b border-white/5">
                    <div className="text-[10px] font-bold text-gray-500 uppercase tracking-widest pl-1 mb-2">
                      Comptes enregistrés
                    </div>
                    <div className="space-y-1 max-h-60 overflow-y-auto custom-scrollbar">
                      {sessions
                        .filter((s) => s.puuid !== session.puuid)
                        .map((s) => (
                          <div
                            key={s.puuid}
                            className={`flex items-center justify-between p-2 rounded-lg group hover:bg-white/5 border border-transparent hover:border-white/5`}
                          >
                            <button
                              onClick={() => {
                            ...
                            >
                              <div className="w-8 h-8 rounded-lg overflow-hidden relative">
                                <img
                                  src={`https://media.valorant-api.com/playercards/${s.playerCardId}/displayicon.png`}
                              ...
                              <div className="flex flex-col">
                                <div className="flex items-center gap-1">
                                  <span
                                    className={`text-xs font-bold ${s.puuid === session.puuid ? "text-blue-400" : "text-gray-300 group-hover:text-white"}`}
                                  >
                                    {s.gameName}
                                  </span>
                                ...
                                <div className="text-[8px] text-gray-500 uppercase font-black tracking-wider flex items-center gap-1">
                                  <img
                                    src={`https://media.valorant-api.com/competitivetiers/03621f52-342b-cf4e-4f86-9350a49c6d04/${s.competitiveTier}/largeicon.png`}
                                    className="w-3 h-3"
                                  />
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative z-10">
        {checking ? (
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-[10px] uppercase font-black tracking-[0.3em] text-blue-400">
          ...
          <div className="max-w-md w-full text-center space-y-8">
            <div className="space-y-3">
              ...
              <p className="text-sm text-gray-400 px-10 leading-relaxed font-medium">
                Connectez-vous via Riot pour synchroniser votre identité
                tactique et vos données de combat.
              </p>
            </div>
            ...
            >
              ...
              {loading ? (
                ...
                <>
                  Continuer avec Riot
                  <span className="text-blue-200 opacity-50 group-hover:translate-x-1 transition-transform">
                    →
                  </span>
                </>
              )}
      ...
      <footer className="mt-5 flex justify-between items-center text-[9px] text-gray-600 font-bold uppercase tracking-widest">
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <span
            className={`transition-colors duration-500 ${isValorantOpen ? "text-green-500" : "text-gray-700"}`}
          >
