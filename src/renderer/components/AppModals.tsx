...
export const QuitModal: React.FC<QuitModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[110] bg-black/60 backdrop-blur-sm flex items-center justify-center p-6">
      <div
        className={`bg-[#1a1a1a] border border-white/10 rounded-3xl w-full max-w-sm overflow-hidden flex flex-col max-h-[90vh] shadow-2xl animate-in zoom-in-95 ${ANIMATION_DURATION}`}
      >
...
export const UpdateModal: React.FC<UpdateModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[110] bg-black/60 backdrop-blur-sm flex items-center justify-center p-6">
      <div
        className={`bg-[#1a1a1a] border border-white/10 rounded-3xl w-full max-w-md overflow-hidden flex flex-col max-h-[90vh] shadow-2xl animate-in zoom-in-95 ${ANIMATION_DURATION}`}
      >
        <div className="p-8 overflow-y-auto scrollbar-hide">
...
export const LaunchConfirmModal: React.FC<LaunchConfirmModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[110] bg-black/60 backdrop-blur-sm flex items-center justify-center p-6">
      <div
        className={`bg-[#1a1a1a] border border-white/10 rounded-3xl w-full max-w-sm overflow-hidden flex flex-col max-h-[90vh] shadow-2xl animate-in zoom-in-95 ${ANIMATION_DURATION} relative`}
      >
        <button
          onClick={onClose}
