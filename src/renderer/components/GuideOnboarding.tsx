...
const steps = [
  {
    ...
    description:
      "Le compagnon ultime pour vos comptes Riot Games. Simple, rapide et pratique",
  },
  {
    id: "config",
    title: "Configuration de Riot",
    description:
      "Nous avons besoin de savoir où se trouve votre Riot Client pour automatiser les connexions",
  },
  {
    id: "tips",
  ...
  },
  {
    ...
    description:
      "Il est temps d'ajouter votre premier compte et de dominer la Faille et d'enchaîner les headshoots sur Valorant",
  },
];
    ...
    <div className="flex flex-col space-y-8 w-full">
      <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
        ...
        <p className="text-sm text-gray-400 mb-6 font-medium leading-relaxed">
          SwitchMaster utilise cet exécutable pour lancer vos jeux
  ...
  const renderTips = () => (
    <div className="grid grid-cols-1 gap-3 w-full">
      <div className="bg-white/5 border border-white/10 rounded-2xl p-4 flex items-start gap-4">
        ...
        <div>
          <h4 className="text-md font-bold text-white uppercase text-[12px] tracking-wider">
            Favoris
          </h4>
          <p className="text-[13px] text-gray-500 mt-1 leading-snug">
            Marquez vos comptes principaux pour y accéder plus vite depuis le
            Dashboard et la barre des tâches
          </p>
        </div>
      </div>
      ...
      <div className="bg-white/5 border border-white/10 rounded-2xl p-4 flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-[13px] text-gray-500 mt-1 leading-snug">
            Utilisez l'icône dans la zone de notification (systray) pour changer
            de compte sans même ouvrir l'application
          </p>
        </div>
      </div>
      ...
      <div className="bg-white/5 border border-white/10 rounded-2xl p-4 flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-[13px] text-gray-500 mt-1 leading-snug">
            Organisez vos comptes librement en les faisant glisser sur le
            Dashboard
          </p>
        </div>
      </div>
  ...
  const renderReady = () => (
    <div className="flex flex-col items-center text-center space-y-6">
      ...
      <p className="text-gray-400 max-w-sm">
        Tout est configuré. SwitchMaster est prêt à booster votre expérience de
        jeu
      </p>
    </div>
  );
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-xl">
      ...
      >
        ...
        {/* Content Area */}
        <div
          className={`flex-1 px-10 flex flex-col justify-center overflow-y-auto custom-scrollbar relative z-10 ${currentStep === 2 ? "" : "items-center"}`}
        >
