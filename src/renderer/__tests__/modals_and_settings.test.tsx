...
describe("Confirmation Modals", () => {
  ...
  it("QuitModal doit gérer les actions", () => {
    const onConfirm = vi.fn();
    render(<QuitModal isOpen={true} onConfirm={onConfirm} onCancel={vi.fn()} />);
  ...
  it("LaunchConfirmModal doit gérer le lancement", () => {
    const onConfirm = vi.fn();
    render(<LaunchConfirmModal isOpen={true} onConfirm={onConfirm} onCancel={vi.fn()} gameName="Valorant" />);
