...
- **Sécurité** : Vos identifiants sont chiffrés. Option de verrouillage par code PIN.
- **Statistiques** : Affichage automatique de votre rang pour chaque compte.
- **Personnalisation** : Support du thème sombre, ajout d'images personnalisées pour vos comptes.
